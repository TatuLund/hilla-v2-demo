...
It contains all the necessary configuration and some placeholder files to get you started. The demo
app is a bit fabricated and is more purposed to demonstrate certain advanced topics in Hilla/React.
...
type `mvn spring-boot:run` then open http://localhost:8080 in your browser.
